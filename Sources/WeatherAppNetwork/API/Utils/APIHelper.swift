...
public class APIHelper {
    ...
    public func setQueryParameters(parameters: [String:Any], url: URL) -> URLComponents {
    ...
    /// - Returns: A URL load request that is independent of protocol or URL scheme.
    public func setRequestHttpMethod(request: inout URLRequest, httpMethod: HTTPMethod) -> URLRequest {
